...
add_custom_command(OUTPUT ${INTERMEDIATE_LICENCE_H}
  COMMAND ${CMAKE_COMMAND}
    -DLICENCE_FILE=${CMAKE_SOURCE_DIR}/putty/LICENCE
    -DOUTPUT_FILE=${INTERMEDIATE_LICENCE_H}
    -P ${CMAKE_SOURCE_DIR}/putty/cmake/licence.cmake
  DEPENDS ${CMAKE_SOURCE_DIR}/putty/cmake/licence.cmake ${CMAKE_SOURCE_DIR}/putty/LICENCE)
...
add_custom_target(check_git_commit
  ...
  COMMAND ${CMAKE_COMMAND}
    ...
    -DOUTPUT_TYPE=header
    -P ${CMAKE_SOURCE_DIR}/putty/cmake/gitcommit.cmake
  DEPENDS ${CMAKE_SOURCE_DIR}/putty/cmake/gitcommit.cmake
  WORKING_DIRECTORY ${CMAKE_SOURCE_DIR}/putty
...
function(be_list TARGET NAME)
  ...
  add_library(${TARGET}-be-list OBJECT ${CMAKE_SOURCE_DIR}/putty/be_list.c)
